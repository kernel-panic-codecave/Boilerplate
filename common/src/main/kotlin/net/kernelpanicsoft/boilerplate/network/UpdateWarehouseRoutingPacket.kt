 ...
 * [net.kernelpanicsoft.boilerplate.warehouse.WarehouseControllerScreen]. The controller's filter
 * slot is a real vanilla slot (see [net.kernelpanicsoft.boilerplate.warehouse.WarehouseControllerMenu.registerSlotHandlers]),
