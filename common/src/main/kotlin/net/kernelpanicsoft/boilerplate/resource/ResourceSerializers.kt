 ...
 * [ResourceComponentSerializer] can dispatch on the wire discriminator (the [net.kernelpanicsoft.boilerplate.resource.ResourceKind.kindTag]).
...
/**
 * A registered [net.kernelpanicsoft.boilerplate.resource.ResourceKind]'s wire form - the kind's [net.kernelpanicsoft.boilerplate.resource.ResourceKind.serializer] under a descriptor
 * named by its [net.kernelpanicsoft.boilerplate.resource.ResourceKind.kindTag], so the polymorphic encoder writes the tag as the discriminator.
 */
