...
/**
 * Matches by [net.kernelpanicsoft.tubularstorage.pipe.entity.TravelingItem.color], the same
 * consignment color a plain [net.kernelpanicsoft.tubularstorage.pipe.entity.RoutingModule.color]
 ...
 * is only ever populated on the push-routing side ([net.kernelpanicsoft.tubularstorage.pipe.network.PipeRouter]) -
...
object ColorConditionType : FilterConditionType<ColorConditionState>() {
	val ID: ResourceLocation = TubularStorage.MOD % "color"
