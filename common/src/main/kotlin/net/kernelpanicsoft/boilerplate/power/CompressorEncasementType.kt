 ...
 * `docs/design/m5-pressure-power.md`. No GUI, matching [PressureTankEncasementType].
 */
object CompressorEncasementType : PressureEncasementType<CompressorEncasementState>() {
	val ID: ResourceLocation = Boilerplate.MOD % "compressor"

	override val id: ResourceLocation get() = ID

	override val partBlock: Block get() = BlockRegistry.CompressorPart
