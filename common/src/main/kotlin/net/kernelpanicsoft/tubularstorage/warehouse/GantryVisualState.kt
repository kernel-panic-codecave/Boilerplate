 ...
 * head-outline colors ([net.kernelpanicsoft.tubularstorage.warehouse.client.WarehouseControllerVisual]/
 * [net.kernelpanicsoft.tubularstorage.warehouse.client.WarehouseControllerBlockEntityRenderer]) and,
