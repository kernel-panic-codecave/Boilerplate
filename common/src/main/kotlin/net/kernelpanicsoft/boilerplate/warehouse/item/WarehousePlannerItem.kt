package net.kernelpanicsoft.boilerplate.warehouse.item
...
/**
 * Binds a [net.kernelpanicsoft.boilerplate.warehouse.entity.WarehouseControllerBlockEntity]'s [net.kernelpanicsoft.boilerplate.warehouse.Bounds] volume - see
 ...
 * [net.kernelpanicsoft.boilerplate.warehouse.Bounds.Companion.of] those two corners to it and clears the wand's selection - provided the controller
 ...
 */
class WarehousePlannerItem(properties: Properties) : Item(properties) {
