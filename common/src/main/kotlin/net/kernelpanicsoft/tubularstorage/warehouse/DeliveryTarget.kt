...
sealed interface DeliveryTarget {
	/**
	 * Ship via a connected pipe to a specific known position - targeted routing ([net.kernelpanicsoft.tubularstorage.pipe.network.PipeRouter.findRouteTo]).
	 * Both a [net.kernelpanicsoft.tubularstorage.pipe.network.RequestFulfillment] request and a
	 ...
	 * [net.kernelpanicsoft.tubularstorage.pipe.hook.PatternProviderHookType]s on different faces of
	 * one block, say) - see [net.kernelpanicsoft.tubularstorage.pipe.entity.TravelingItem.targetFace]'s
