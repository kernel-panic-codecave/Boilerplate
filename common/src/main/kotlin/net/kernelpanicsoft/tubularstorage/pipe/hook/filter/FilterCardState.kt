 ...
 * [net.kernelpanicsoft.tubularstorage.pipe.gui.FilterCardMenu] (which declares this exact same
 ...
 * by [net.kernelpanicsoft.tubularstorage.pipe.hook.SortingHookState]'s outer grid and
