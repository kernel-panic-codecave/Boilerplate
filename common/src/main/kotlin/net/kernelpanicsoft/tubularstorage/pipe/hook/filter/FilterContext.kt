 ...
 * [net.kernelpanicsoft.tubularstorage.pipe.network.PipeRouter]'s push-routing side; a standing
 * request pulled via [net.kernelpanicsoft.tubularstorage.pipe.network.RequestFulfillment] has no
