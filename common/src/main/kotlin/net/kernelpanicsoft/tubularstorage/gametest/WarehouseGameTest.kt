...
class WarehouseGameTest {
	...
	/**
	 * [WarehouseScale.REGIONAL] drives indexing through [ChunkParallelScanTask][net.kernelpanicsoft.tubularstorage.warehouse.ChunkParallelScanTask]
	 ...
	 * [IncrementalTickScanTask][net.kernelpanicsoft.tubularstorage.warehouse.IncrementalTickScanTask]
	...
	/**
	 * [net.kernelpanicsoft.tubularstorage.warehouse.WarehouseDefragPlanner] should consolidate a
	 * resource scattered across two racks into whichever already holds more of it, via a real
	 * [net.kernelpanicsoft.tubularstorage.warehouse.GantryJob.Move] round trip - not through either
	 * staging buffer.
	 */
	@GameTest(template = SMALL, timeoutTicks = 400)
