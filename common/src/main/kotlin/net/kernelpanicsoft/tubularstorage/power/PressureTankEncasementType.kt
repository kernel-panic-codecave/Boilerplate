...
object PressureTankEncasementType : PipeEncasementType<PressureTankEncasementState>() {
	val ID: ResourceLocation = TubularStorage.MOD % "pressure_tank"
	...
	/** Drives [net.kernelpanicsoft.tubularstorage.registry.BlockRegistry.PressureTankPart]'s per-face variant off this segment's own connections - see [pressureCasingRenderState]. */
