...
import net.kernelpanicsoft.tubularstorage.network.SetGhostSlotPacket
...
class SortingHookScreen(private val menu: SortingHookMenu, playerInventory: Inventory, title: Component) :
	...
	fun content() {
		...
		fun setSlot(index: Int, resource: ItemResource) {
			...
			TubularStorageNetworkChannel.toServer(SetGhostSlotPacket(FilterCardTarget.HookFilterSlot(menu.pos, menu.direction, index), resource))
		}
