...
/**
 * Renders a [GlassPipeBlockEntity]'s carried [net.kernelpanicsoft.boilerplate.pipe.entity.TravelingItem]s
 ...
 * forward there), not [net.kernelpanicsoft.boilerplate.pipe.entity.PipeBlockEntity.travelingItems]
