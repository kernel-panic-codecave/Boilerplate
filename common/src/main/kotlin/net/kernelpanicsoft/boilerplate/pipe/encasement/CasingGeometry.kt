...
/**
 * Collision/targeting geometry for a [net.kernelpanicsoft.boilerplate.pipe.block.ConnectingEncasementModelBlock]
 ...
 * [net.kernelpanicsoft.boilerplate.pipe.block.PipeBlock]'s cross-section, 0.375 for the pressure
