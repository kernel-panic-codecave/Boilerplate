 ...
 * `priority`/`color` go unused here - [net.kernelpanicsoft.boilerplate.pipe.network.RequestFulfillment]
 * only ever reads [SortingHookState.accepts] - but reusing the whole type (and
 * [net.kernelpanicsoft.boilerplate.pipe.gui.SortingHookMenu]/[net.kernelpanicsoft.boilerplate.pipe.gui.SortingHookScreen])
