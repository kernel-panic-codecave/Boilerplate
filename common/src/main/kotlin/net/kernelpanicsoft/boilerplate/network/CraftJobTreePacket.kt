 ...
 * [net.kernelpanicsoft.boilerplate.crafting.CraftingBufferJob.toTree] - [resource]/[amount] is
 * the craft step's own output, [status]/[done]/[progress] its current progress
 * ([net.kernelpanicsoft.boilerplate.crafting.CraftingBufferJob.stepStatus] for the text; [progress] is
 ...
 * [net.kernelpanicsoft.boilerplate.pipe.gui.CraftingTreeView]'s own "advancements-style" layout.
 */
@Serializable
...
/** Server -> client: reply to [RequestCraftJobTreePacket] - the requesting player's currently open terminal-family menu's own trees, one per in-flight job ([net.kernelpanicsoft.boilerplate.crafting.CraftingBufferJob.toTree] skips a job whose own target was fully covered straight from stock - nothing to show a tree for), empty if nothing is in progress. */
@Serializable
