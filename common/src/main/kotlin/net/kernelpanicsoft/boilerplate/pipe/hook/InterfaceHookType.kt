 ...
 * face (see [net.kernelpanicsoft.boilerplate.registry.TileRegistry.Multipart]) so anything
 * physically touching it - a hopper, another mod's pipe, or another Boilerplate hook facing it
 ...
 * anchors, so it shows up in [net.kernelpanicsoft.boilerplate.pipe.network.RequestFulfillment]'s
 ...
 * [net.kernelpanicsoft.boilerplate.pipe.network.RequestFulfillment]'s own reachability BFS
 ...
 * stock).
 *
 * Also the anchor of Boilerplate's subnet-boundary system (see
