...
/**
 * GameTest coverage for [net.kernelpanicsoft.boilerplate.crafting.CraftingBufferEncasementState.cancelJob] -
 * the server-side operation behind the Crafting Buffer menu's own Cancel buttons
 * ([net.kernelpanicsoft.boilerplate.crafting.gui.CraftingBufferScreen]).
 */
@Suppress("unused")
