 ...
 * [net.kernelpanicsoft.tubularstorage.crafting.PatternKind.CRAFTING] - computed on demand, nothing
 * stored here) or up to 9 manually-specified ghost outputs ([ghostOutputs]/[ghostOutputAmounts],
 * [net.kernelpanicsoft.tubularstorage.crafting.PatternKind.PROCESSING]) - authors a
 * [net.kernelpanicsoft.tubularstorage.crafting.Pattern] without needing the real items in hand, the
 ...
 * [net.kernelpanicsoft.tubularstorage.crafting.PatternItem]s for encoding to draw from, rather than
