...
/** A plain 3x3 [Slots] grid over [InterfaceHookMenu]'s `stock` group - the whole GUI, chest-simple, matching [net.kernelpanicsoft.tubularstorage.pipe.hook.InterfaceHookType]'s "normal interaction is like the ME interface" role. */
