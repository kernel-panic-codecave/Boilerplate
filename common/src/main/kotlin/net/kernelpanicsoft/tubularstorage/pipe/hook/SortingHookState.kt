...
import net.kernelpanicsoft.tubularstorage.pipe.hook.filter.FilterContext
import net.kernelpanicsoft.tubularstorage.pipe.hook.filter.evaluateGhostSlot
...
abstract class SortingHookState(defaultType: ResourceLocation) : HookHolderState(defaultType) {
	 ...
	 * [net.kernelpanicsoft.tubularstorage.pipe.hook.filter.FilterCardItem]'s own richer
	 * condition (see [net.kernelpanicsoft.tubularstorage.pipe.hook.filter.evaluateGhostSlot]) -
	 * never real, extractable items, so placing one here never actually removes it from a
	 * player's inventory. Mutated by [net.kernelpanicsoft.tubularstorage.network.SetGhostSlotPacket],
	 ...
	 * Shared by [net.kernelpanicsoft.tubularstorage.pipe.network.PipeRouter]'s push-routing search
	 * and [net.kernelpanicsoft.tubularstorage.pipe.network.RequestFulfillment]'s pull-request search
