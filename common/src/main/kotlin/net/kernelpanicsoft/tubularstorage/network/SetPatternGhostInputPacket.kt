...
/** Client -> server: overwrites ghost input [index] with [resource] (or clears it, for [earth.terrarium.common_storage_lib.resources.item.ItemResource.BLANK]) on whichever [PatternTerminalHookMenu] the requesting player currently has open - see [net.kernelpanicsoft.tubularstorage.pipe.gui.GhostSlot]'s own left-click handling. */
@Serializable
