 ...
 * [net.kernelpanicsoft.boilerplate.pipe.encasement.EncasementHolderState] that exposes an
 * item-storage surface through [net.kernelpanicsoft.boilerplate.warehouse.rack.exposeCommonItemStorage]'s
 * generic lookup on [net.kernelpanicsoft.boilerplate.registry.TileRegistry.Multipart] - a new
 ...
 * fallback search (see [net.kernelpanicsoft.boilerplate.registry.TileRegistry.Multipart]'s own
 * KDoc) - [net.kernelpanicsoft.boilerplate.pipe.hook.InterfaceHookState] deliberately implements
