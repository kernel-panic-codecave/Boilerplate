 ...
 * Exists purely so a [net.kernelpanicsoft.tubularstorage.pipe.attachment.PipeAttachmentType] has a
 ...
 * `<type>_part` (see [net.kernelpanicsoft.tubularstorage.registry.BlockRegistry]).
 *
 ...
 * [net.kernelpanicsoft.tubularstorage.pipe.entity.MultipartBlockEntity]. [RenderShape.MODEL] only
