 ...
 * whole-segment counterpart to [net.kernelpanicsoft.tubularstorage.pipe.hook.PipeHookType], and so
 ...
 * [net.kernelpanicsoft.tubularstorage.registry.Registrars]/[net.kernelpanicsoft.tubularstorage.registry.EncasementTypeRegistry]),
 ...
 * body's own [net.kernelpanicsoft.tubularstorage.pipe.block.PipeBlock.CORE_SHAPE] while hooks and
...
abstract class PipeEncasementType<S : EncasementHolderState> : PipeAttachmentType<S>() {
	 ...
	 * [net.kernelpanicsoft.tubularstorage.pipe.block.PipeBlock.CORE_SHAPE] as the segment's base
	 ...
	 * [net.kernelpanicsoft.tubularstorage.pipe.attachment.PipeAttachmentType.getRenderState].
	 *
