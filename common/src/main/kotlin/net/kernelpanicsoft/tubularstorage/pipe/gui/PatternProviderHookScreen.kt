...
/** A plain 3x3 [Slots] grid over [PatternProviderHookMenu]'s `patterns` group - drop encoded [net.kernelpanicsoft.tubularstorage.crafting.PatternItem]s in, the hook does the rest. */
