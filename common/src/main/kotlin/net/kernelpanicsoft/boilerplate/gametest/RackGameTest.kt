 ...
 * ([net.kernelpanicsoft.boilerplate.warehouse.rack.GeneralRackBlockEntity]/
...
class RackGameTest {
	...
	/**
	 * Confirms [net.kernelpanicsoft.boilerplate.warehouse.WarehouseIndex.scanPosition] discovers
	 ...
	 * [net.kernelpanicsoft.boilerplate.warehouse.rack.exposeCommonItemStorage] actually wires
