 ...
 * cluster - [net.kernelpanicsoft.tubularstorage.pipe.hook.advanceTerminalJobs] mirrors
 * [net.kernelpanicsoft.tubularstorage.pipe.hook.MultipartBlockEntity.craftJobStatus] from whatever the
 * CPU itself reports, and drops the [SubmittedJobRef] once done - the terminal never drives
 * execution or receives the result directly, matching how [net.kernelpanicsoft.tubularstorage.pipe.gui.AbstractTerminalHookMenu.submitCraft]
