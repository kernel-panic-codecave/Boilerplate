 ...
 * ([net.kernelpanicsoft.tubularstorage.pipe.gui.CraftingTerminalHookMenu.craftOnce]), not the slow,
 * pattern-driven kind ([PatternProviderHookType][net.kernelpanicsoft.tubularstorage.pipe.hook.PatternProviderHookType]).
