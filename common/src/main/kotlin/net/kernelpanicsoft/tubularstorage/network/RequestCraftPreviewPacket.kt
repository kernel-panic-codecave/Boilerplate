 ...
 * [net.kernelpanicsoft.tubularstorage.crafting.AssemblyTableBlockEntity]'s own patterns combined),
 * up to [upperBound] - a dry run, nothing is requested. Replies with [CraftPreviewPacket].
 */
@Serializable
