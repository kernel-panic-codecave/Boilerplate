 ...
 * only wins in [net.kernelpanicsoft.tubularstorage.pipe.network.PipeRouter]'s candidate search
 ...
 * [net.kernelpanicsoft.tubularstorage.network.UpdateSortingRoutingPacket] clears it from any other
