 ...
 * [net.kernelpanicsoft.tubularstorage.pipe.hook.HookHolderState] exactly (see its own KDoc for why
 ...
 * [net.kernelpanicsoft.tubularstorage.network.UpdateFilterCardFieldPacket] never needs to know the
