 ...
 * pattern slot ([net.kernelpanicsoft.boilerplate.crafting.CraftingBufferJob.patternIndexForStep]),
 * not [net.kernelpanicsoft.boilerplate.pipe.hook.PatternBufferIO]'s round-robin, which has no
