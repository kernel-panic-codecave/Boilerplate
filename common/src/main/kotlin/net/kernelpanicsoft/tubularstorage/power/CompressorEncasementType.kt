 ...
 * [net.kernelpanicsoft.tubularstorage.power.network.PressurePipeNetworkManager]'s own equalization
...
object CompressorEncasementType : PipeEncasementType<CompressorEncasementState>() {
	val ID: ResourceLocation = TubularStorage.MOD % "compressor"

	override val id: ResourceLocation get() = ID

	/** Attachable only on a dedicated pressure-pipe segment (see [net.kernelpanicsoft.tubularstorage.pipe.attachment.PipeAttachmentType.compatibleNetworkTypes]). */
	...
	/** Drives [net.kernelpanicsoft.tubularstorage.registry.BlockRegistry.CompressorPart]'s per-face variant off this segment's own connections - see [pressureCasingRenderState]. */
	...
	/** See [net.kernelpanicsoft.tubularstorage.crafting.CraftingBufferEncasementType.onRemoved]'s identical note on [net.kernelpanicsoft.tubularstorage.pipe.block.MultipartBlock]'s own removal-path caveat. */
