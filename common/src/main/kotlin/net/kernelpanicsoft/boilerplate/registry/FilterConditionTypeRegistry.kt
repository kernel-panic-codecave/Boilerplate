...
import net.kernelpanicsoft.boilerplate.pipe.hook.filter.ColorConditionState
import net.kernelpanicsoft.boilerplate.pipe.hook.filter.ColorConditionType
...
/** Registers Boilerplate's [FilterConditionType]s into the custom registry [Registrars] declares - see [HookTypeRegistry]'s own identical shape. */
