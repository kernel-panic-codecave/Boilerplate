...
/**
 * GameTest coverage for [PipeNetworkManager]'s chunked-BFS rebuild ([net.kernelpanicsoft.tubularstorage.pipe.network.AbstractPipeNetworkManager.tick])
 * respecting [net.kernelpanicsoft.tubularstorage.pipe.network.SubnetBoundary.isBoundaryEdge] - the
