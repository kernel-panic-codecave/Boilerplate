...
/**
 * Builds Boilerplate's loot tables:
 *
 * - every player-facing block simply drops itself - the wrench-gating lives in the block
 *   properties (`requiresCorrectToolForDrops`) and the `boilerplate:mineable/wrench` tag, not
 *   here;
 ...
 */
internal fun boilerplateLootTables(): Map<ResourceKey<LootTable>, LootTable.Builder> {
