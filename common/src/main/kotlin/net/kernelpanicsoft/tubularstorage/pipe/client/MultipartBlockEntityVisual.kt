...
import net.kernelpanicsoft.tubularstorage.pipe.client.MultipartBlockEntityVisual.Companion.rotationFor
 ...
 * [net.kernelpanicsoft.tubularstorage.pipe.encasement.PipeEncasementType.getRenderState] answer -
 * states of those types' hidden part blocks (see
 * [net.kernelpanicsoft.tubularstorage.pipe.block.PartBlock]), whose blockstate definitions select
...
class MultipartBlockEntityVisual(
	...
	companion object {
		/** Stand-in "previous state" for a [getRenderState][net.kernelpanicsoft.tubularstorage.pipe.attachment.PipeAttachmentType.getRenderState] call with no cached answer of its own yet - air, so an unknown/unregistered part id also bakes as nothing rather than crashing. */
