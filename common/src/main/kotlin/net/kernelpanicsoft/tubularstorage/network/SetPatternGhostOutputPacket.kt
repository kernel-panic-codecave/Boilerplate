...
/** Client -> server: overwrites ghost output [index] with [resource] at [amount] (or clears it, for [earth.terrarium.common_storage_lib.resources.item.ItemResource.BLANK]) on whichever [PatternTerminalHookMenu] the requesting player currently has open - only meaningful in [net.kernelpanicsoft.tubularstorage.crafting.PatternKind.PROCESSING], up to 9 of these. */
@Serializable
